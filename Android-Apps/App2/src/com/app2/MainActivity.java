...
public class MainActivity extends Activity {
	...
	private void register() throws Exception{
		...
		sdl.registerApp(this, "DoorbellApp2", getApplicationContext());
		// register the service "DoorbellApp" whose intent filter name is "DoorbellApp"
		serviceId = sdl.registerNewService("DoorbellApp2");
		Log.e(TAG, serviceId);
		
		//TODO location setting is not done yet
		sdl.addLocation();
		sdl.registerTriggers("onDoorbell", "onDoorbell2", this.getClass());
	}
