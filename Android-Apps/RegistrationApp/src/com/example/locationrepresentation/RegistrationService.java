...
/**
 * This is the Registration service which communicate with both the 
 * UIs and android communication process. It has the logic of accomplishing
 * one task.
 * 
 * @author Pengcheng
 */
public class RegistrationService extends android.app.Service{
	...
	/**
	 * This function contains registration of service, actions and triggers
	 * @throws Exception
	 */
	...
	/**
	 * This is the callback method that will be invoked once the 
	 * trigger "getInfo" is received
	 * @param actionInput
	 * @param srcServiceId
	 */
