...
/**
 * This class is the reliable multicast layer which broadcasts and 
 * receives messages. The responsibility of this layer is to shield upper
 * layer from retries.
 * 
 * @author parth
 *
...
public class MulticastLayer {
	...
	/**
	 * Set the maximum retries according to the number of devices.
	 */
	...
	/**
	 * Every time a message is being sent, the multicast layer will create
	 * a new Sender thread to send message and do the retries. 
	 */
	 ...
	 *         False if exception is encountered
	 */
	...
	/**
	 * Once a new message is received, the multicast layer will create a
	 * new thread which delivers the message to upper layer. 
	 */
